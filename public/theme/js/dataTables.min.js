...
! function(n) {
    ...
    function vt(t, e) {
        var n = e.nTr,
            a = e._aData;
        n && ((t = t.rowIdFn(a)) && (n.id = t), a.DT_RowClass && (t = a.DT_RowClass.split(" "), e.__rowc = e.__rowc ? z(e.__rowc.concat(t)) : t
    ...
    function Lt(n) {
        ...
        var t = n.oClasses,
            ...
            //VERGERO SEARCH01 XXXXXXXXXXXXXXXXX03


            //l = '<input type="search" class="' + t.sFilterInput + '"/>',
            l = '<input name="search" type="search" />',
            ...
            //AQUI SE ASOCIA EL mwc-textfield
            u = P("input", l).val(o.sSearch).attr("placeholder"," Busca los registros").on("keyup.DT search.DT input.DT paste.DT cut.DT", t ? ne(e, t) : e).on("mouseup", function(t) {
                setTimeout(function() {
                    e.call(u[0], t)
                }, 10)
    ...
    function Vt(t) {
        ...
        0 !== l.length && (i = t.oLanguage, e = t._iDisplayStart + 1, n = t.fnDisplayEnd(),
            ...
            //null !== (i = i.fnInfoCallback) && (o = i.call(t.oInstance, t, e, n, a, r, o)),P(l).html(o))
    }
    ...
    function $t(a) {
        ...
        //campo de mostrar cantidad de registros XXXXXXXXXXXX01

        var select = '<select name="type_of_device_id" >'+
        ...
        return a.aanFeatures.l || (c[0].id = e + "_length"),
            c.children().append(a.oLanguage.sLengthMenu.replace("_MENU_", select)), P("select", c).val(a._iDisplayLength).on("change.DT", function(t) {

                // cambio de valor de busqueda l[0].outerHTML
            
                var esval = P(this).val();
    ...
    function zt(t) {
        ...
        var f = C.ext.pager[e];
        var d = "function" == typeof f;
        var e = P("<div/>").addClass(t.oClasses.sPaging + e + ' btn-group');
        /*e.css('margin-right','30px');
        ...
        e = e[0];
        //XXXXXXXXXXXXXXXX05
        //AQUI SE CREA EL PADRE DE LA PAGINACION
            ...
            fn: function(t) {
                if (d){
                    for (var e = t._iDisplayStart, n = t._iDisplayLength, a = t.fnRecordsDisplay(),
                        r = -1 === n, o = r ? 0 : Math.ceil(e / n), i = r ? 1 : Math.ceil(a / n),
                        l = f(o, i), s = 0, u = h.p.length;
                        s < u; s++)
                    {
    ...
    function Yt(t, e, n) {
        ...
        var r = t._iDisplayLength;
        var o = t.fnRecordsDisplay();

        var o = (0 === o || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) 
            : "first" == e ? a = 0 : "previous" == e ? (a = 0 <= r ? a - r 
                : 0) < 0 && (a = 0) : "next" == e ? a + r < o && (a += r) 
            : "last" == e ? a = Math.floor((o - 1) / r) * r 
            : W(t, 0, "Unknown paging action: " + e, 5), t._iDisplayStart !== a);
    ...
    function Kt(t) {
        var e, n, a, r, o, i, l, s, u, c, f, d, h = P(t.nTable),
            p = t.oScroll;
        return "" === p.sX && "" === p.sY ? t.nTable : (e = p.sX, n = p.sY, a = t.oClasses, o = (r = h.children("caption")).length ? r[0]._captionSide : null,
        
         s = P(h[0].cloneNode(!1)), i = P(h[0].cloneNode(!1)), u = function(t) {
    ...
    function Oe(t, e) {
        var n = [];
        var a = He.numbers_length;
        var r = Math.floor(a / 2);

  

        var sar = e <= a ? n = f(0, e) : t <= r ? ((n = f(0, a - 2)).push("ellipsis"), 
            n.push(e - 1)) : ((e - 1 - r <= t ? n = f(e - (a - 2), e) 
                ...
                function h(t, e) {
                    ...
                    for (var n, a, r = b.sPageButtonDisabled, o = function(t) {
                        ...
                        if (n = e[i], Array.isArray(n)) {
                            ...
                            null !== p && me(P('<button class="btn btn-outline-primary" type="button">', {
