...
@section('content')
    ...
    <div class="pagetitle">
        <h1>Ediar Serie de matrícula</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section dashboard">
        <div class="card mb-4">
            <div class="card-body mw-100 w-px-800 m-md-auto">
                <h3 class="card-title">Matrícula {{ mb_strtolower($model->formato) }}</h3>


                <form class="row" action="{{ url('serie-matricula/update') }}" method="POST" id="frmCreate">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <div class="form-floating">
                            <input name="consecutivo_matricula" type="number" class="form-control" placeholder="1..." value="{{ $model->consecutivo_matricula }}"/>
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <div class="form-floating">
                            <input name="limite_matricula" type="number" class="form-control" placeholder="9999..." value="{{ $model->limite_matricula }}"/>
                    ...
                    <div class="col-12">
                        ...
                        <div class="flex space-x-4 border-0">
                            ...
                            <input name="permitir_modificar" id="tack_checkbox" type="checkbox" class="form-checkbox" 
                                   {{ ($model->permitir_modificar ? 'checked' : '') }} />
