                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <select class="form-control" name="genero">
                                ...
                                @foreach($gu as $v)
                                    @if($model->profesor)
                                        @if($model->profesor->genero_usuario_id==$v->id)
                                        <option value="{{ $v->id }}" selected>{{ $v->genero }}</option>
                                        @else
                        ...
                        <div class="form-floating">
                            <select class="form-control" name="estado_civil">
                                ...
                                @foreach($ec as $v)
                                    ...
                                    @if($model->profesor)
                                        @if($model->profesor->estado_civil_id==$v->id)
                                        <option value="{{ $v->id }}" selected>{{ $v->estado_civil }}</option>
                                        @else
