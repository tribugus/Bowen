            ...
            <div class="card-header py-3 pb-2">
                <div class="row">
                    <h3 class="m-0 font-weight-bold text-primary">
                        ...
                        <div class="float-end">
                            @if(PUR(R1))
                            <a href="{{ url('profesores/inactivos') }}" class="btn btn-secondary mr-1 ">ver inactivos <i class="fa fa-check "></i></a>
                            @endif
                            @if(PUR(R1.R2))
                            <a href="{{ url('profesores/crear') }}" class="btn btn-primary">agregar profesor <i class="fa fa-add"></i></a>
                            @endif
                        </div>
...
function btn(id){
    html = '<div class="dropdown">'
           ...
           +'     <a class="dropdown-item" href="{{ url("/") }}/profesores/edit/'+id+'"><i class="bx bx-edit-alt me-1"></i> Edit</a>'
           +'     <form action="{{ url("/") }}/profesores/delete/'+id+'"" method="POST">'
           +'        @csrf @method("DELETE")'
