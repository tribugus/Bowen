            ...
            <div class="card-header py-3 pb-2">
                <div class="row">
                    <h3 class="m-0 font-weight-bold text-primary">
                        ...
                        <div class="float-end">
                            <a href="{{ url('ciclo-escolar') }}" class="btn btn-danger mx-3 ml-0 ">Quitar filtro <i class="fa fa-close"></i></a>
                        </div>
                ...
                <table id="example" class="table w-100 mb-3 text-muted ">
                    <thead class="text-muted">
                        <tr>
                            ...
                            <th class="text-muted">Inicial</th>
                            <th class="text-muted">Final</th>
                            <th class="text-muted">Periodo</th>
                            <th class="text-muted">Descripción</th>
                            <th class="text-muted">Abreviatura</th>
                            <th class="text-muted">Denominación</th>
                            <th class="text-muted"></th>
                        </tr>
                    </thead>
                </table>
...
function btn(id){
    html = '<div class="dropdown ">'
           ...
           +'     <form action="{{ url("/") }}/ciclo-escolar/active/'+id+'"" method="POST">'
           +'        @csrf'
